    ...
    if use_amr_sweeper_gnss:
        actions.append(_scoped_include(
            ...
            "amr_sweeper_gnss.launch.py",
            {
                ...
                "robot_pose_topic": LaunchConfiguration("simulation_robot_pose_topic").perform(context),
                "log_level": log_level,
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            "simulation_robot_pose_topic",
            default_value="/amr_sweeper/simulation/robot_pose",
        ),
