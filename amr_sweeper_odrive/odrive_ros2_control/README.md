...
The BotWheel Explorer example package was removed during consolidation.
...
- `motor_direction`: `CCW` or `CW` to define the motor direction sign used for command and feedback conversion
