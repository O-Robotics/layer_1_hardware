...
#include "amr_sweeper_odrive/msg/o_drive_status.hpp"
#include "amr_sweeper_odrive/msg/controller_status.hpp"
#include "amr_sweeper_odrive/msg/control_message.hpp"
#include "amr_sweeper_odrive/srv/axis_state.hpp"
...
using ODriveStatus = amr_sweeper_odrive::msg::ODriveStatus;
using ControllerStatus = amr_sweeper_odrive::msg::ControllerStatus;
using ControlMessage = amr_sweeper_odrive::msg::ControlMessage;

using AxisState = amr_sweeper_odrive::srv::AxisState;
