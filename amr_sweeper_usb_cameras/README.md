...
- The default USB camera parameter files stamp images and camera info with `<camera_name>_optical_frame` so projection-aware consumers use the ROS optical convention directly.
