^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package amr_sweeper_ublox_dgnss
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* Merge pull request `#7 <https://github.com/aussierobots/amr_sweeper_ublox_dgnss/issues/7>`_ from CMP-Engineers/navsatfix
  Navsatfix
