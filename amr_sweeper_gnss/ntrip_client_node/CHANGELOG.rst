^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package amr_sweeper_ntrip_client_node
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

0.5.3 (2024-03-22)
------------------
* Merge pull request `#18 <https://github.com/aussierobots/amr_sweeper_ublox_dgnss/issues/18>`_ from tfoldi/user_agent
