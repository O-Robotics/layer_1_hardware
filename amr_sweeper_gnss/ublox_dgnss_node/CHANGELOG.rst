^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package amr_sweeper_ublox_dgnss_node
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
* fixed line length
* Merge branch 'main' of github.com:aussierobots/amr_sweeper_ublox_dgnss
* Merge pull request `#12 <https://github.com/aussierobots/amr_sweeper_ublox_dgnss/issues/12>`_ from gsokoll/main
...
------------------
* updates for release
* Merge pull request `#10 <https://github.com/aussierobots/amr_sweeper_ublox_dgnss/issues/10>`_ from aussierobots/F9R-and-RTCM
  F9 r and rtcm
* changed verbosity of logging
* Merge pull request `#9 <https://github.com/aussierobots/amr_sweeper_ublox_dgnss/issues/9>`_ from gsokoll/F9R-and-RTCM
  Composable node version of navsatfix
* Composable node version of navsatfix.  Added example launch file.
* Merge pull request `#8 <https://github.com/aussierobots/amr_sweeper_ublox_dgnss/issues/8>`_ from gsokoll/F9R-and-RTCM
...
* Merge pull request `#6 <https://github.com/aussierobots/amr_sweeper_ublox_dgnss/issues/6>`_ from gsokoll/gsokoll-patch-1
...
* Merge pull request `#4 <https://github.com/aussierobots/amr_sweeper_ublox_dgnss/issues/4>`_ from gsokoll/patch-1
