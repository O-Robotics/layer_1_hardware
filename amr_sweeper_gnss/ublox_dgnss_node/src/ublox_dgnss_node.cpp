...
#include "amr_sweeper_gnss/msg/ubx_nav_clock.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_cov.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_dop.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_eoe.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_hp_pos_ecef.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_hp_pos_llh.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_odo.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_orb.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_sat.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_sig.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_pos_ecef.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_pos_llh.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_pvt.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_rel_pos_ned.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_status.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_time_utc.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_vel_ecef.hpp"
#include "amr_sweeper_gnss/msg/ubx_nav_vel_ned.hpp"
#include "amr_sweeper_gnss/msg/ubx_rxm_rtcm.hpp"
#include "amr_sweeper_gnss/msg/ubx_rxm_measx.hpp"
#include "amr_sweeper_gnss/msg/ubx_rxm_rawx.hpp"
#include "amr_sweeper_gnss/msg/ubx_esf_status.hpp"
#include "amr_sweeper_gnss/msg/ubx_esf_meas.hpp"
#include "amr_sweeper_gnss/msg/ubx_sec_sig.hpp"
#include "amr_sweeper_gnss/msg/ubx_sec_sig_log.hpp"
#include "amr_sweeper_gnss/msg/ubx_sec_uniqid.hpp"
#include "amr_sweeper_gnss/srv/hot_start.hpp"
#include "amr_sweeper_gnss/srv/warm_start.hpp"
#include "amr_sweeper_gnss/srv/cold_start.hpp"
#include "amr_sweeper_gnss/srv/reset_odo.hpp"
...
public:
  ...
  : Node("amr_sweeper_ublox_dgnss", rclcpp::NodeOptions(options)
      .automatically_declare_parameters_from_overrides(true))
  {
    ...
    hot_start_service_ = this->create_service<amr_sweeper_gnss::srv::HotStart>(
      node_name + "/hot_start", std::bind(&UbloxDGNSSNode::hot_start_callback, this, _1, _2));
    cold_start_service_ = this->create_service<amr_sweeper_gnss::srv::ColdStart>(
      node_name + "/cold_start", std::bind(&UbloxDGNSSNode::cold_start_callback, this, _1, _2));
    warm_start_service_ = this->create_service<amr_sweeper_gnss::srv::WarmStart>(
      node_name + "/warm_start", std::bind(&UbloxDGNSSNode::warm_start_callback, this, _1, _2));
    reset_odo_service_ = this->create_service<amr_sweeper_gnss::srv::ResetODO>(
    ...
    ubx_esf_meas_sub_ = this->create_subscription<amr_sweeper_gnss::msg::UBXEsfMeas>(
      "/ubx_esf_meas_to_device", 10, std::bind(&UbloxDGNSSNode::ubx_esf_meas_callback, this, _1));
    rtcm_sub_ = this->create_subscription<amr_sweeper_gnss::msg::Message>(
...
// so put them in a queue, with a timestamp to be processed later
  ...
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavDOP>::SharedPtr ubx_nav_dop_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavEOE>::SharedPtr ubx_nav_eoe_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavHPPosECEF>::SharedPtr ubx_nav_hp_pos_ecef_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavHPPosLLH>::SharedPtr ubx_nav_hp_pos_llh_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavOdo>::SharedPtr ubx_nav_odo_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavOrb>::SharedPtr ubx_nav_orb_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavSat>::SharedPtr ubx_nav_sat_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavSig>::SharedPtr ubx_nav_sig_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavPosECEF>::SharedPtr ubx_nav_pos_ecef_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavPosLLH>::SharedPtr ubx_nav_pos_llh_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavPVT>::SharedPtr ubx_nav_pvt_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavRelPosNED>::SharedPtr ubx_nav_rel_pos_ned_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavStatus>::SharedPtr ubx_nav_status_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavTimeUTC>::SharedPtr ubx_nav_time_utc_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavVelECEF>::SharedPtr ubx_nav_vel_ecef_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXNavVelNED>::SharedPtr ubx_nav_vel_ned_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXRxmRTCM>::SharedPtr ubx_rxm_rtcm_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXRxmMeasx>::SharedPtr ubx_rxm_measx_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXRxmRawx>::SharedPtr ubx_rxm_rawx_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXEsfStatus>::SharedPtr ubx_esf_status_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXEsfMeas>::SharedPtr ubx_esf_meas_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXSecSig>::SharedPtr ubx_sec_sig_pub_;
  rclcpp::Publisher<amr_sweeper_gnss::msg::UBXSecSigLog>::SharedPtr ubx_sec_sig_log_pub_;

  rclcpp::Subscription<amr_sweeper_gnss::msg::UBXEsfMeas>::SharedPtr ubx_esf_meas_sub_;
  rclcpp::Subscription<amr_sweeper_gnss::msg::Message>::SharedPtr rtcm_sub_;

  rclcpp::Service<amr_sweeper_gnss::srv::HotStart>::SharedPtr hot_start_service_;
  rclcpp::Service<amr_sweeper_gnss::srv::WarmStart>::SharedPtr warm_start_service_;
  rclcpp::Service<amr_sweeper_gnss::srv::ColdStart>::SharedPtr cold_start_service_;
  rclcpp::Service<amr_sweeper_gnss::srv::ResetODO>::SharedPtr reset_odo_service_;
...
// on set parameters callback function
  ...
  void hot_start_callback(
    const std::shared_ptr<amr_sweeper_gnss::srv::HotStart::Request> request,
    std::shared_ptr<amr_sweeper_gnss::srv::HotStart::Response> response)
  {
    RCLCPP_WARN(
  ...
  void warm_start_callback(
    const std::shared_ptr<amr_sweeper_gnss::srv::WarmStart::Request> request,
    std::shared_ptr<amr_sweeper_gnss::srv::WarmStart::Response> response)
  {
    RCLCPP_WARN(
  ...
  void cold_start_callback(
    const std::shared_ptr<amr_sweeper_gnss::srv::ColdStart::Request> request,
    std::shared_ptr<amr_sweeper_gnss::srv::ColdStart::Response> response)
  {
    RCLCPP_WARN(
  ...
  void reset_odo_callback(
    const std::shared_ptr<amr_sweeper_gnss::srv::ResetODO::Request> request,
    std::shared_ptr<amr_sweeper_gnss::srv::ResetODO::Response> response)
  {
  ...
  UBLOX_DGNSS_NODE_LOCAL
  void ubx_esf_meas_callback(const amr_sweeper_gnss::msg::UBXEsfMeas & msg) const
  {
  ...
  UBLOX_DGNSS_NODE_LOCAL
  void rtcm_callback(const amr_sweeper_gnss::msg::Message & msg) const
  {
...
private:
    ...
    std::shared_ptr<ubx::nav::velecef::NavVelECEFPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavVelECEF>();
    ...
    std::shared_ptr<ubx::nav::velned::NavVelNEDPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavVelNED>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    ...
    std::shared_ptr<ubx::nav::timeutc::NavTimeUTCPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavTimeUTC>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    ...
    std::shared_ptr<ubx::nav::relposned::NavRelPosNedPayload> payload)
  {
    RCLCPP_DEBUG(
      ...
      f->ubx_frame->msg_class, f->ubx_frame->msg_id,
      payload->to_string().c_str());
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavRelPosNED>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
  ...
  void ubx_nav_pvt_pub(ubx_queue_frame_t * f, std::shared_ptr<ubx::nav::pvt::NavPvtPayload> payload)
  {
    RCLCPP_DEBUG(
      ...
      f->ubx_frame->msg_class, f->ubx_frame->msg_id,
      payload->to_string().c_str());
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavPVT>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    msg->year = payload->year;
    ...
    std::shared_ptr<ubx::nav::posllh::NavPosLLHPayload> payload)
  {
    RCLCPP_DEBUG(
      ...
      f->ubx_frame->msg_class, f->ubx_frame->msg_id,
      payload->to_string().c_str());
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavPosLLH>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    msg->lon = payload->lon;
    ...
    std::shared_ptr<ubx::nav::posecef::NavPosECEFPayload> payload)
  {
    RCLCPP_DEBUG(
      ...
      f->ubx_frame->msg_class, f->ubx_frame->msg_id,
      payload->to_string().c_str());
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavPosECEF>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    ...
    std::shared_ptr<ubx::nav::odo::NavOdoPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavOdo>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->version = payload->version;
    msg->itow = payload->iTOW;
    ...
    std::shared_ptr<ubx::nav::orb::NavOrbPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavOrb>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->version = payload->version;
    msg->itow = payload->itow;
    ...
    for (const auto & sv_info_payload : payload->sv_info) {
      amr_sweeper_gnss::msg::OrbSVInfo sv_info_msg;
    ...
    std::shared_ptr<ubx::nav::sat::NavSatPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavSat>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->version = payload->version;
    msg->itow = payload->itow;
    ...
    for (const auto & sv_info_payload : payload->sat_data) {
      amr_sweeper_gnss::msg::SatInfo sv_info_msg;
      sv_info_msg.gnss_id = sv_info_payload.gnss_id;
      sv_info_msg.sv_id = sv_info_payload.sv_id;
    ...
    std::shared_ptr<ubx::nav::sig::NavSigPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavSig>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->version = payload->version;
    msg->itow = payload->itow;
    ...
    for (const auto & sig_data_payload : payload->sig_data) {
      amr_sweeper_gnss::msg::SigData sig_data_msg;
    ...
    std::shared_ptr<ubx::nav::hpposllh::NavHPPosLLHPayload> payload)
  {
    RCLCPP_DEBUG(
      ...
      f->ubx_frame->msg_class, f->ubx_frame->msg_id,
      payload->to_string().c_str());
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavHPPosLLH>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->version = payload->version;
    ...
    std::shared_ptr<ubx::nav::hpposecef::NavHPPosECEFPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavHPPosECEF>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->version = payload->version;
    msg->itow = payload->iTOW;
    ...
    std::shared_ptr<ubx::nav::status::NavStatusPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavStatus>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    ...
    std::shared_ptr<ubx::nav::eoe::NavEOEPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavEOE>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    ...
    std::shared_ptr<ubx::nav::dop::NavDOPPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavDOP>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    ...
    std::shared_ptr<ubx::nav::cov::NavCovPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavCov>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    msg->version = payload->version;
    ...
    std::shared_ptr<ubx::nav::clock::NavClockPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXNavClock>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    ...
    std::shared_ptr<ubx::rxm::rtcm::RxmRTCMPayload> payload)
  {
    RCLCPP_DEBUG(
      ...
      f->ubx_frame->msg_class, f->ubx_frame->msg_id,
      payload->to_string().c_str());
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXRxmRTCM>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->version = payload->version;
    ...
    std::shared_ptr<ubx::rxm::measx::RxmMeasxPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXRxmMeasx>();
    ...
    for (const auto & sv_data_payload : payload->sv_data) {
      amr_sweeper_gnss::msg::MeasxData sv_data_msg;
    ...
    std::shared_ptr<ubx::rxm::rawx::RxmRawxPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXRxmRawx>();
    ...
    for (const auto & meas_data_payload : payload->meas_data) {
      amr_sweeper_gnss::msg::RawxData meas_data_msg;
    ...
    std::shared_ptr<ubx::esf::status::ESFStatusPayload> payload)
  {
    RCLCPP_DEBUG(
      ...
      f->ubx_frame->msg_class, f->ubx_frame->msg_id,
      payload->to_string().c_str());
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXEsfStatus>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    msg->itow = payload->iTOW;
    msg->version = payload->version;
    ...
    for (int i = 0; i < payload->numSens; i++) {
      auto s_msg = std::make_unique<amr_sweeper_gnss::msg::ESFSensorStatus>();
    ...
    std::shared_ptr<ubx::esf::meas::ESFMeasPayload> payload)
  {
    RCLCPP_DEBUG(
      ...
      f->ubx_frame->msg_class, f->ubx_frame->msg_id,
      payload->to_string().c_str());
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXEsfMeas>();
    msg->header.frame_id = frame_id_;
    msg->header.stamp = f->ts;
    ...
    for (uint i = 0; i < numMeas; i++) {
      ...
      auto data_msg = std::make_unique<amr_sweeper_gnss::msg::ESFMeasDataItem>();
    ...
    std::shared_ptr<ubx::sec::sig::SecSigPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXSecSig>();
    ...
    std::shared_ptr<ubx::sec::siglog::SecSigLogPayload> payload)
  {
    ...
    auto msg = std::make_unique<amr_sweeper_gnss::msg::UBXSecSigLog>();
    ...
    for (const auto & event_payload : payload->events) {
      amr_sweeper_gnss::msg::SigLogEvent event_msg;
...
RCLCPP_COMPONENTS_REGISTER_NODE(amr_sweeper_ublox_dgnss::UbloxDGNSSNode)
