^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package amr_sweeper_ublox_nav_sat_fix_hp_node
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
------------------
* fixed formatting
* Merge pull request `#14 <https://github.com/aussierobots/amr_sweeper_ublox_dgnss/issues/14>`_ from gsokoll/main
